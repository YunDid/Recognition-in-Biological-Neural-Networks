...
%
% 特点:
%   - 单通道爆发检测使用ISI方法参数：NN=5, isi_nn=0.4
%   - 活跃电极定义为含有至少20个爆发的电极
%   - 网络爆发定义为至少20%活跃电极参与的事件(网络爆发检测参数：NN=2, isi_nn=0.1)
%
% 使用方法：
...
%   3. 运行脚本进行批量分析
%
% 注意: 此脚本特别适用于自发放电(spontaneous activity)数据分析，
%       数据路径结构为：主文件夹/实验组/spike/*.mat
