...
''' read recording '''
folder_path = Path('E:/Voice_Data_Eight/20250310/C3_20250310_MCon_Cell0218/si_sorting/before')
# folder_path = Path('E:/Mww_data/weiwei_mong/hdf5/时空刺激/同质脑/0822_1/0930/spon')

output_path = Path('E:/Voice_Data_Eight/20250310/C3_20250310_MCon_Cell0218/si_sorting/after')
...
for file_name in file_names:
    ...
    sorting = ss.run_sorter(sorter_name="mountainsort5", recording=recording_preprocessed,
                            ...
                            detect_threshold=4, detect_time_radius_msec=1.5,
    ...
    # print(params)
    ''' extract waveforms '''
    we_MS5 = si.extract_waveforms(recording_preprocessed, sorting, folder=waveforms_folder, overwrite=None)
    print(we_MS5)
    # unit_id0 = sorting.unit_ids[0]
    # waveforms = we_MS5.get_waveforms(unit_id0)
    # print(waveforms.shape)
    # template = we_MS5.get_template(unit_id0)
