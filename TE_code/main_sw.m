...
for i = 1:length(contents)
    if contents(i).isdir && ~strcmp(contents(i).name, '.') && ~strcmp(contents(i).name, '..')
        ...
        % 构建保存文件夹的完整路径
%         savedir2=strcat(subFolder,'/network/');
%         mkdir(savedir2);
        savedir1=strcat(subFolder,'/te-network/random/');
        mkdir(savedir1)
        % 遍历子文件夹内的每个文件
...
%             std_w = std(W(~eye(size(W))));
            ...
            NW=cell(100,1);
            for g=1:100
                W00 = null_model_dir_sign(W,20,0.1);
                NW{g,1}=W00;
...
savepath2=strcat('/Users/mengweiwei/Desktop/结果/spon/network/','0401-0.35-clustering-coefficient.xlsx');
writematrix(CC, savepath2);
savepath2=strcat('/Users/mengweiwei/Desktop/结果/spon/network/','0401-0.35-transitivity.xlsx');
writematrix(T, savepath2);
savepath2=strcat('/Users/mengweiwei/Desktop/结果/spon/network/','0401-0.35-modularity.xlsx');
writematrix(M, savepath2);
savepath2=strcat('/Users/mengweiwei/Desktop/结果/spon/network/','0401-0.35-characteristic-path-length.xlsx');
writematrix(CPL, savepath2);
savepath2=strcat('/Users/mengweiwei/Desktop/结果/spon/network/','0401-0.35-mean-STTC.xlsx');
writematrix(mean_STTC, savepath2);
savepath2=strcat('/Users/mengweiwei/Desktop/结果/spon/network/','0401-0.35-corr.xlsx');
